...
%if %{?hostos}
%global target_list   ppc-softmmu,ppcemb-softmmu,ppc64-softmmu,ppc-linux-user,ppc64-linux-user,ppc64abi32-linux-user,ppc64le-linux-user
%endif
%endif
%ifarch s390x
...
Name: qemu
Version: 3.0.0
Release: 0.1%{?rcrel}%{gitcommittag}%{?dist}
Epoch: 15
...
Patch1001: patch-Revert-qemu-pr-helper-use-new-libmultipath-API.txt
